...
type InboundMessageMetadata = { messageId?: string; chatType?: "private" | "group"; isMentioned?: boolean; skipAgent?: boolean; fromUser?: string; fromUserId?: string; channelType?: string; };
