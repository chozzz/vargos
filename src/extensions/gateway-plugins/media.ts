import { InputPlugin, type InputType, type NormalizedInput, type PreparedInput, type GatewayContext, type GatewayResponse, type StreamingChunk } from '../../core/gateway/types.js';
import { saveMedia } from '../../core/lib/media.js';
