...
3. Select a different model: We default to anthropic/claude-sonnet-4-5-20250929. You can select a compatible chat model using provider/model-name via configuration. Example: openai/gpt-4.
