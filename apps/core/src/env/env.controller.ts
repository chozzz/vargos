...
export class EnvController {
  ...
  @ApiQuery({ name: 'search', required: false, description: 'Search keyword for env variable key or value' })
  @ApiResponse({ status: 200, description: 'List of environment variables', type: [EnvVarDto] })
  ...
  @ApiResponse({ status: 200, description: 'The environment variable', type: EnvVarDto })
  ...
  @ApiResponse({ status: 200, description: 'Environment variable set successfully' })
