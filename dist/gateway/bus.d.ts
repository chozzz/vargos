...
export type CallableEventKey = {
    [E in keyof EventMap]: EventMap[E] extends {
        params: unknown;
        result: unknown;
    } ? E : never;
}[keyof EventMap];
...
export type EventParams<E extends CallableEventKey> = EventMap[E] extends {
    params: infer P;
} ? P : never;
/** Extract result type from a callable event */
export type EventResult<E extends CallableEventKey> = EventMap[E] extends {
    result: infer R;
} ? R : never;
/**
 ...
 */
export type HandlerOf<E extends keyof EventMap> = E extends CallableEventKey ? (params: EventParams<E>) => Promise<EventResult<E>> : (payload: EventMap[E]) => void | Promise<void>;
