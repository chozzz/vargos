...
export class TelegramAdapter extends BaseChannelAdapter {
    ...
    constructor(instanceId, botToken, deps, allowFrom) {
    ...
    async handleMedia(chatId, msg, normalizedMsg) {
        ...
        try {
            const { caption, savedPath, mimeType } = await this.processInboundMedia(msg, (text) => this.onInboundMessage(sessionKey, { ...normalizedMsg, text }), sessionKey, this.shouldExecute(chatId, normalizedMsg.chatType, normalizedMsg.isMentioned));
